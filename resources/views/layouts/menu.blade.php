<div class="menu-sect">
    <div class="main d-flex flex-column">
        ...
        <ul class="bottom flex-column" style="display: none;">
            <li>
                <div class="list">
                    <a href="#" class="ttl"><img src="images/menu/subscription.svg" class="mtm4"
                            alt="" />
            ...
            <li>
                <div class="list">
                    <a href="#" class="ttl"><img src="images/menu/help-circle.svg" class="mtm4"
                            alt="" /> <span>Help
                            & Support</span></a>
                </div>
            </li>
            <li>
                <div class="list">
                    <a href="#" class="ttl"><img src="images/menu/ind-flag.svg" class="mtm4"
                            alt="" />
                        <span>INDIA</span></a>
                </div>
            </li>
